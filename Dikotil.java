...
public class Dikotil extends Tumbuhan {
    ...
    /**
     * @return the polaVenasi
     */
    public String getPolaVenasi() {
        return polaVenasi;
    }

    /**
     * @param polaVenasi the polaVenasi to set
     */
    public void setPolaVenasi(String polaVenasi) {
        this.polaVenasi = polaVenasi;
    }
}
